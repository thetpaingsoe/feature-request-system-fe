...
<template>
  <DashboardLayout>
  <div v-if="submissionStore.getData.isLoading" class="flex justify-center mt-12 items-center flex-row">
    <LoaderCircle v-if="submissionStore.getData.isLoading" class="h-4 w-4 animate-spin me-2" /> Loading ...
  </div>
